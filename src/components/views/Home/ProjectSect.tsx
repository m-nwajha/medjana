    ...
    <section className="ul_home_project_sect">
      <div className="container">
        <div className="ul_title_with_des_box">
          <h2 className="ul_title">selected projects </h2>
          <p className="ul_short_des ul_short_des_max_width">
            A curated showcase of our most impactful work — blending strategy, storytelling, and standout visuals to bring brands to life.
          </p>
        </div>
        <div className="ul_home_project_collection_wrapper w-dyn-list">
          <div role="list" className="ul_home_project_collection_list w-dyn-items ">
            <div role="listitem" className="ul_home_project_collection_items w-dyn-item">
              <Link href="/project/fasho-ecommerce-website" className="ul_home_project_collection_box w-inline-block hover:bg-[#fbd30b]!">
                ...
                <div className="ul_home_project_content_flex_box">
                  <div data-w-id="e032babd-685a-cc0e-0a22-43fd7be77919" className="ul_home_project_img_box">
                  ...
                  <div className="ul_home_project_content_box">
                    <h3 className="ul_home_project_content_title">Fasho eCommerce Website</h3>
            ...
            <div role="listitem" className="ul_home_project_collection_items w-dyn-item">
              <Link href="/project/pulsefit-gym-websie" className="ul_home_project_collection_box w-inline-block hover:bg-[#fbd30b]!">
                <div className="ul_home_project_name_flex_box">
                ...
                <div className="ul_home_project_content_flex_box">
                  ...
                  <div className="ul_home_project_content_box">
                    <h3 className="ul_home_project_content_title">Pulsefit Gym Websie</h3>
                    <p className="ul_short_des">
            ...
            <div role="listitem" className="ul_home_project_collection_items w-dyn-item">
              <Link href="/project/aiflow-agency-website" className="ul_home_project_collection_box w-inline-block hover:bg-[#fbd30b]!">
                <div className="ul_home_project_name_flex_box">
                ...
                <div className="ul_home_project_content_flex_box">
                  ...
                  <div className="ul_home_project_content_box">
                    <h3 className="ul_home_project_content_title">Aiflow Agency Website</h3>
                    <p className="ul_short_des">
